...
@PostgreSQL_Source @Postgresql_Required
Feature: PostgreSQL - Verify data transfer from PostgreSQL source to BigQuery sink and PostgreSQL sink

  @POSTGRESQL_SOURCE_TEST @BQ_SINK_TEST @POSTGRESQL_SINK_TEST @PLUGIN-1526
  ...
  @POSTGRESQL_SOURCE_TEST @POSTGRESQL_SINK_TEST @BQ_SINK_TEST
