...
@CLOUDSQL
Feature: CLOUDSQL Source - Run Time scenarios

  Scenario: Verify user should be able to preview the pipeline when plugin is configured for fetching table details
            within database using CloudSQLPostGreSQL source to BQ sink
