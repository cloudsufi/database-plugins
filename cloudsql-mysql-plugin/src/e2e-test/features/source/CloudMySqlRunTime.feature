...
@CloudMySqll @CloudMySql_Requiredd
...
#  @CLOUDMYSQL_SOURCE_DATATYPES_TEST @CLOUDMYSQL_TARGET_DATATYPES_TEST @PLUGIN-20670
...
#    Then Validate the values of records transferred to target table is equal to the values from source table
#
#   @CLOUDMYSQL_SOURCE_DATATYPES_TEST @CLOUDMYSQL_TARGET_DATATYPES_TEST
