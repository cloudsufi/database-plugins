...
#    Then Validate "CloudSQL MySQL" plugin properties
    ...
    Then Click plugin property: "allowSchemaRelaxation"
...
#    Then Validate OUT record count is equal to records transferred to target BigQuery table
  ...
  Scenario: To verify data is getting transferred from CloudMySql source to BigQuery sink successfully using long datatypes
    Given Open Datafusion Project to configure pipeline
    When Expand Plugin group in the LHS plugins list: "Source"
    When Select plugin: "CloudSQL MySQL" from the plugins list as: "Source"
    When Expand Plugin group in the LHS plugins list: "Sink"
...
#    Then Validate OUT record count is equal to records transferred to target BigQuery table
  ...
  Scenario: To verify data is getting transferred from CloudMySql source to BigQuery sink successfully using long raw datatypes
    Given Open Datafusion Project to configure pipeline
    When Expand Plugin group in the LHS plugins list: "Source"
    When Select plugin: "CloudSQL MySQL" from the plugins list as: "Source"
    When Expand Plugin group in the LHS plugins list: "Sink"
...
#    Then Validate OUT record count is equal to records transferred to target BigQuery table
  ...
  Scenario: To verify data is getting transferred from CloudMySql source to BigQuery sink successfully using long Varchar datatypes
    Given Open Datafusion Project to configure pipeline
    When Expand Plugin group in the LHS plugins list: "Source"
    When Select plugin: "CloudSQL MySQL" from the plugins list as: "Source"
    When Expand Plugin group in the LHS plugins list: "Sink"
...
#    Then Validate OUT record count is equal to records transferred to target BigQuery table
  ...
  Scenario: To verify data is getting transferred from CloudMySql source to BigQuery sink successfully when connection arguments are set
    Given Open Datafusion Project to configure pipeline
    When Expand Plugin group in the LHS plugins list: "Source"
    When Select plugin: "CloudSQL MySQL" from the plugins list as: "Source"
    When Expand Plugin group in the LHS plugins list: "Sink"
...
#    Then Validate OUT record count is equal to records transferred to target BigQuery table
  ...
  Scenario: To verify data is getting transferred from CloudMySql source to BigQuery sink successfully using different datatypes
    Given Open Datafusion Project to configure pipeline
    When Expand Plugin group in the LHS plugins list: "Source"
    When Select plugin: "CloudSQL MySQL" from the plugins list as: "Source"
    When Expand Plugin group in the LHS plugins list: "Sink"
