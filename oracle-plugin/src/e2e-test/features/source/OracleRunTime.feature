...
Feature: Oracle - Verify Oracle source data transfer
  ...
  @ORACLE_SOURCE_DATATYPES_TEST2 @BQ_SINK_TEST @Oracle_Required
  ...
  @ORACLE_SOURCE_LONGRAW_TEST @BQ_SINK_TEST @Oracle_Required
  ...
  @ORACLE_SOURCE_DATATYPES_TEST4 @BQ_SINK_TEST @Oracle_Required
