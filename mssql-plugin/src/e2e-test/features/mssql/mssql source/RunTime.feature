...
Feature: Mssql - Verify Mssql source data transfer
  ...
  Scenario: To verify data is getting transferred from Mssql to BigQuery successfully with bounding Query
    Given Open Datafusion Project to configure pipeline
    When Expand Plugin group in the LHS plugins list: "Source"
    When Select plugin: "SQL Server" from the plugins list as: "Source"
    When Expand Plugin group in the LHS plugins list: "Sink"
  ...
  @MSSQL_SOURCE_DATATYPES_TEST @MSSQL_TARGET_DATATYPES_TEST @CONNECTION @Mssql_Required
  Scenario: To verify data is getting transferred from Mssql to Mssql successfully with use connection
    Given Open Datafusion Project to configure pipeline
    When Expand Plugin group in the LHS plugins list: "Source"
    When Select plugin: "SQL Server" from the plugins list as: "Source"
    When Expand Plugin group in the LHS plugins list: "Sink"
